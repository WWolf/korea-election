...
theme_set(
  theme_bw() + 
    theme(text = element_text(size=10, family="Batang"))
)
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  ggtitle("읍면동(행정동)별 2016년 총선 대 2017년 대선 투표율 변화\n(붉은 추세선=1.2배, 별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  ggtitle("읍면동(행정동)별 2016년 총선 대 2017년 대선 더불어민주당 득표율 변화\n(별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
```
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  ggtitle("읍면동(행정동)별 2016년 총선 대 2017년 대선 새누리 후계 제정당 득표율 변화\n(별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
```
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  ggtitle("읍면동(행정동)별 2016년 총선 새누리 대 2017년 대선 자유한국당 득표율 변화\n(별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
```
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  # ) +
  labs(x="2016년 총선 비례대표 새누리당 득표율", y="2017년 대선 자유한국당 득표율") +
  ggtitle("읍면동(행정동)별 2016년 총선 새누리 대 2017년 대선 자유한국당 득표율 변화 (영남)\n(별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
```
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  ggtitle("읍면동(행정동)별 2016년 총선 새누리 대 2017년 대선 국민의당 득표율 변화\n(별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
```
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  ggtitle("읍면동(행정동)별 2016년 총선 대 2017년 대선 바른정당후보 득표율 변화\n(별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
```
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  # ) +
  labs(x="2016년 총선 비례대표 새누리당 득표율", y="2017년 대선 바른정당 득표율") +
  ggtitle("읍면동(행정동)별 2016년 총선 대 2017년 대선 바른정당 득표율 변화 (서울특별시)\n(별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
```
...
#  scale_y_continuous(breaks=c(0.5, 1.0, 1.5, 2.0, 2.5)) +
  ...
  ggtitle("읍면동(행정동)별 2016년 총선 대 2017년 대선 정의당후보 득표율 변화\n(별표는 선거인수 변화가 큰 읍면동)\n(관외사전투표/재외투표 제외)")
```
